...
- MADE BY : CRIMINAL
- Telegram: @xYz_CriminalL
- channel: CRYPTO CRACKERS
    ...
    foreach ($users as $userId => $userData) {
        ...
        if ($httpCode === 200) {
            ...
            if ($reward) {
                ...
                echo printColored("[ REPORT ] If facing issue again and again Send Details and ScreenShot Contact Developer Telegram @xYz_CriminalL\n", $yellow);
                continue;
            }
        } elseif ($httpCode === 403) {
